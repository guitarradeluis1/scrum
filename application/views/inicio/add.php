...
<div class="card">
	<div class="card-body">
		...
		<tr>
			<td>
				<p><b>Titulo : </b><br /> 
				<?php echo form_input(array("name" => "titulo", "id" => "titulo", "placeholder" => "titulo", "type" => "text", "class"=>"form-control form-control-sm")); ?>
				</p>
			</td>
			<td>
				<p><b>Semana : </b><br /> 
			...
			<td>
				<p><b>Prioridad : </b><br /> 
				<?php echo form_input(array("name" => "prioridad", "id" => "prioridad", "placeholder" => "prioridad", "type" => "number", "class"=>"form-control form-control-sm")); ?>
				</p>
			</td>
		</tr>
		<tr>
