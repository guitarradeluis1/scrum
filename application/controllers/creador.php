...
class Creador extends CI_Controller {
     /*
...
//_____________________________________________________
    public function parametros()
    {
       ...
       #if(isset($id) && $id !="")
       {
           ...
           $parametros["controlador"] = "creador";
           $parametros["titulo_general"] = "Creadores";
           $parametros["funcion"] = "";
           $parametros["carpeta"] = "creador";
...
public function index()
{
    ...
    $datos = $parametros;
    $datos["Salida"] = $this->creador_model->todo();
...
public function vista($id)
{
    ...
    $datos = $parametros;
    $datos["Salida"] = $this->creador_model->consulto($id);
    $this->load->view($parametros["estilo"],$datos);
    $this->load->view($parametros["carpeta"]."/".$parametros["funcion"], $datos);
    $this->load->view("footer");
}
...
public function add()
{
    ...
    if (isset($_POST["post"]) )
    {
        #if ($_POST['opcion']!="")
        {
            ...
            $resultado = $this->creador_model->nuevo($_POST);
            if($resultado != "") 
            {
